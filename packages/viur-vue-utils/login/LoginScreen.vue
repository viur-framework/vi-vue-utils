      ...
      >
        ...
        >
          <img
            ...
            :src="appStore.publicAsset('token.svg')"
            class="token"
          />
          <img
            v-else
...
<script>
import { reactive, computed, onBeforeMount, defineComponent, watch, inject } from "vue"
...
import UserLoginMask from "@/components/Screens/TheLoginScreen/UserLoginMask.vue"
