  ...
  <div class="wrapper">
    ...
    >
      ...
      <div
        ...
        "
      >
        <div id="google_oauth" ref="testbtn"></div>
        <sl-alert
...
<script setup>
import { reactive, computed, onBeforeMount, defineComponent, watch,ref, onMounted } from "vue"
...
import UserLoginMask from "./dynamicRender/UserLoginMask.vue"
  ...
  const props = defineProps( {
    ...
    function googleLogin() {
      if (testbtn.value) {
          window.google.accounts.id.renderButton(testbtn.value, { theme: "outline", size: "large" });
      }
      userStore.state.currentLoginMask = "google"
